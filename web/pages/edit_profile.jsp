			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="../edit_profile">
                                            <p><input type="text" name="nick" required class="myInput" value="<%= name %>" placeholder="Nome de usuário"></p>
						<p><input type="email" name="email" required class="myInput" value="<%= email %>" placeholder="E-mail"></p>
						<br />
						<p><input type="submit" class="btn btn-success" id="submitButton" value="Salvar"></p>
					</form>
				</div>
			</div>
		</div>
